		...
		<div id="header" class="center text_align_right">
			<?php
				...
				if (empty($_SESSION[SESSION_USER])) {
					echo '<a class="link_horizontal" href="login.php">Log-In</a>'.PHP_EOL;
					echo "\t\t\t", '<a class="link_horizontal" href="register.php">Register</a>'.PHP_EOL;
				}
				else {
					echo '<a class="link_horizontal" href="logout.php">Log-Out</a>'.PHP_EOL;;
					echo "\t\t\t", '<a class="link_horizontal" href="accountinfo.php">Account Info</a>'.PHP_EOL;
				}
			?>
			...
			<div id="menu">
				<ul>
					<?php		
						// Will update this to pull the genres from the database
